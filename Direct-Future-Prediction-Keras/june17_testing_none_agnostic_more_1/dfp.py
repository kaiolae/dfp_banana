...
if __name__ == "__main__":
    ...
    SAVE_TO_FOLDER = "june17_testing_none_agnostic_more_2"
    ...
    env = UnityEnv("../unity_envs/kais_banana2", worker_id=7, use_visual=True,  flatten_branched=True) #KOE: Note: If I accept images as uint8_visual=True, I have to convert to float later.
