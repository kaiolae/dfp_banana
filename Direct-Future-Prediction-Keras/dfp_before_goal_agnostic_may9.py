...
if __name__ == "__main__":
    ...
    SAVE_TO_FOLDER = "may16_reverted_to_before_goal_agnostic_run2"
    ...
    env = UnityEnv("../unity_envs/kais_banana2", worker_id=22, use_visual=True, uint8_visual=True, flatten_branched=True)
