...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana2", worker_id=30, use_visual=True, uint8_visual=True, flatten_branched=True)
    ...
    SAVE_TO_FOLDER = "may23_fixed_visual_input_kais2_single_goal"
