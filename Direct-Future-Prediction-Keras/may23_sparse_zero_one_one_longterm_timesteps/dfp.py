...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana3", worker_id=24, use_visual=True, uint8_visual=True, flatten_branched=True)
    ...
    timesteps = [4,8,16,32,64,128]#[1,2,4,8,16,32] # For long horizon: [4,8,16,32,64,128]
    ...
    SAVE_TO_FOLDER = "may23_sparse_zero_one_one_longterm_timesteps"
