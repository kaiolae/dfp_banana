...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana3", worker_id=42, use_visual=True, flatten_branched=True) #KOE: Note: If I accept images as uint8_visual=True, I have to convert to float later.
    ...
    SAVE_TO_FOLDER = "may24_fixed_visual_input_kais3_both_goals"
