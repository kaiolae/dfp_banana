...
class DFPAgent:
    ...
    def __init__(self, state_size, measurement_size, action_size, timesteps):
        ...
        self.gamma = 0.99
        self.learning_rate = 0.000001 #KOE: Original value 0.00001. Trying ten times less after problems may 2019
...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana2", worker_id=18, use_visual=True, uint8_visual=True, flatten_branched=True)
    ...
    SAVE_TO_FOLDER = "may21_Fully_reverted_to_may7_both_food_and_poison_slower_learning"
