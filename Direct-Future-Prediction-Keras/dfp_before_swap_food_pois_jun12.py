...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana5", worker_id=45, use_visual=True,  flatten_branched=True) #KOE: Note: If I accept images as uint8_visual=True, I have to convert to float later.
