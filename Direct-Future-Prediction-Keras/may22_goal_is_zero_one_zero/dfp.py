...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana2", worker_id=20, use_visual=True, uint8_visual=True, flatten_branched=True)
    ...
    goal = np.array([0.0, 1.0, 0.0] * len(timesteps))
    SAVE_TO_FOLDER = "may22_goal_is_zero_one_zero"
