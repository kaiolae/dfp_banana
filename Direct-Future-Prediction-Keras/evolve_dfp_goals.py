...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        eval_result = evaluate_a_goal_vector([0,0,0], env, dfp_net, goal_producing_network=net, display=False)
...
if __name__ == "__main__":
    global store_to_folder
    store_to_folder = "evo_test/" #TODO: Add as input argument
    ...
    global env
    env = UnityEnv("../unity_envs/kais_banana_with_battery_consumable_balanced", worker_id=49, use_visual=True, flatten_branched=True)
