...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana2", worker_id=43, use_visual=True,  flatten_branched=True) #KOE: Note: If I accept images as uint8_visual=True, I have to convert to float later.
    ...
    SAVE_TO_FOLDER = "june12_kais2_swapped_code_reversed" #
