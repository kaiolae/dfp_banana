...
if __name__ == "__main__":
    ...
    env = UnityEnv("../unity_envs/kais_banana2", worker_id=19, use_visual=True, uint8_visual=True, flatten_branched=True)
    ...
    loaded_model = "may7_statistics_both_goals_without_laser_4000_episodes/model/dfp.h5"
